  ...
  return (
    <div className={`flex fixed w-full justify-between p-4 z-50 transition-colors duration-300 bg-white text-black border-b border-b-[rgba(0,0,0,0.1)]`}>
      ...
      <div className="flex items-center py-2 px-4">
        ...
        <nav className={`fixed flex flex-col items-center justify-start pt-28 md:pt-0 space-y-8 md:flex-row top-0 left-0 w-3/4 h-full font-medium text-[20px] transition-transform md:bg-transparent bg-white transform ${menuOpen ? 'translate-x-0' : '-translate-x-full'} md:relative md:flex-row md:space-y-0 md:space-x-8 md:text-[20px] md:translate-x-0`}>
