...
function Terms() {
    return (
        <>
            <Navbar />
            <div className='flex flex-col pt-24 p-8 gap-5 text-[16px] mono-sans'>
                ...
                <div className="flex flex-col gap-3">
                    <h3 className='font-bold'>3. Disclaimers</h3>
                ...
                <div className="flex flex-col gap-3">
                    <h3 className='font-bold'>4. QR Code Functionality</h3>
                ...
                <div className="flex flex-col gap-3">
                    <h3 className='font-bold'>5. Third-Party Links</h3>
                ...
                <div className="flex flex-col gap-3">
                    <h3 className='font-bold'>6. Amendments</h3>
